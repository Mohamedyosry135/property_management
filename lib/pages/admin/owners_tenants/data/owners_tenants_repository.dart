...
import 'owners_tenants_api_provider.dart';

abstract class IOwnersTenatsRepository {
...
class OwnersTenatsRepository extends BaseRepository implements IOwnersTenatsRepository {
  OwnersTenatsRepository({required this.provider});
  final IOwnersTenatsProvider provider;
