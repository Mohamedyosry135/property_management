...
class OwnersTenatsView extends GetView<OwnersTenatsController> {
  @override
  Widget build(BuildContext context) {
    print(convertArabicToEnglish("dd١٢٣٤٥٦٧٨٩٠"));
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          CustomText(
                            text: controller.isOwner!
                                ? CommonLang.owners.tr()
                      ...
                      CustomButton(
                        onPressed: () async{
                         await Get.rootDelegate. offNamed(Routes.ADD_TENANT_OWNER,
                              arguments: [
                                {"isOwner": "owner"}
                              ]).then((value){
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            CustomText(
                                text: controller.isOwner!
                                    ? CommonLang.addOwner.tr()
                                    : CommonLang.addTenant.tr(),
                                textStyle: TextStyles.textMedium18.copyWith(
                                    fontSize: 14,
                      ...
                      (state) => Expanded(
                            ...
                            child: Container(
                              ...
                              child: Obx(() => DataTable(
                                ...
                                columns: <DataColumn>[
                                  dateColumn(controller.isOwner!
                                      ? CommonLang.owner.tr()
                                      : CommonLang.tenant.tr()),
                      ...
                      onError: (String? err) => Center(
                            child: CustomText(
                              ...
                              textStyle: TextStyles.textBold25.copyWith(
                                  fontSize: 26, color: Color(ColorCode.blue)),
                            ),
                          )),
                  SizedBox(
                    height: 30.h,
