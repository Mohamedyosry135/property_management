...
import 'package:property_managment/pages/admin/representative_owners_tenants/presentation/controllers/representative_owners_tenants_controller.dart';
...
class  RepresentativeOwnersView extends GetView<RepresentativeOwnersTenantsController> {
              ...
              children: [
                Row(
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        CustomText(
                          text: controller.isRepresentativeOwner!
                              ? CommonLang.representativeOwner.tr()
                    ...
                    CustomButton(
                      onPressed: () async{
                        await Get.rootDelegate. offNamed(Routes.ADD_REPRESENTATIVE_TENANT_OWNER,arguments: [{"isRepresentativeOwner":controller.isRepresentativeOwner!}]).then((value){
                          controller.getUsers(controller.isRepresentativeOwner!);
                        });
                      },
