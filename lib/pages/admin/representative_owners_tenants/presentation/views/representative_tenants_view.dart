...
class RepresentativeTenantsView extends GetView<RepresentativeOwnersTenantsController> {
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    CustomButton(
                      onPressed: () async{
                      await Get.rootDelegate. offNamed(Routes.ADD_REPRESENTATIVE_TENANT_OWNER,arguments: [{"isRepresentativeOwner":false}]).then((value){
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          CustomText(
                              text:  CommonLang.addTenantRepresentative.tr(),
                              textStyle: TextStyles.textMedium18.copyWith(
                                  fontSize: 14,
