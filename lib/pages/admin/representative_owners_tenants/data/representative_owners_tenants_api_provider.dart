...
abstract class IRepresentativeOwnersTenantsProvider {
  Future<List<Users>> getUsers(String role);


}

class RepresentativeOwnersTenantsProvider extends BaseAuthProvider implements IRepresentativeOwnersTenantsProvider {
  @override
